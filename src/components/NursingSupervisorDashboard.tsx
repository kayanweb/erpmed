      ...
      <div className="flex flex-col xl:flex-row gap-6 h-full items-stretch">
         ...
         <div className="flex-1 space-y-6 overflow-hidden">
                ...
                <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                      <div className="bg-emerald-50 border border-emerald-100 rounded-lg p-3 text-center">
                         <div className="text-lg sm:text-2xl font-black text-emerald-600 font-mono">8</div>
                         <div className="text-[10px] font-bold text-emerald-800">{isAr ? "أسرة شاغرة وجاهزة" : "Ready Empty Beds"}</div>
                      </div>
                      <div className="bg-amber-50 border border-amber-100 rounded-lg p-3 text-center">
                         <div className="text-lg sm:text-2xl font-black text-amber-600 font-mono">3</div>
            ...
            {activeTab === "forms" && activeForm === "none" && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 animate-fade-in text-slate-800">
            ...
            {activeTab === "interactive" && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-fade-in">
                 ...
                 <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex-1 flex flex-col h-full min-h-0">
                    <div>
