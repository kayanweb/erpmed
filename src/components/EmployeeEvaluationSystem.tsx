              ...
              <div className="p-6 md:p-8 space-y-8 bg-white max-w-4xl mx-auto border-x border-slate-100 shadow-sm min-h-[500px]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-slate-50/50 rounded-2xl border border-slate-200 overflow-hidden">
                    {getCriteriaList().map((crit, idx) => (
                      <div key={crit.id} className={`p-4 flex flex-col xl:flex-row xl:items-center justify-between gap-4 ${idx !== getCriteriaList().length - 1 ? 'border-b border-slate-100' : ''}`}>
                ...
                <div className="pt-4 border-t border-slate-100 flex justify-end">
                   <button 
                     ...
                     className="px-8 py-3.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-black shadow-lg shadow-indigo-600/30 flex flex-wrap items-center gap-2 sm:gap-3 transition-transform hover:-translate-y-0.5 active:translate-y-0"
                   >
                     <CheckCircle size={18} />
