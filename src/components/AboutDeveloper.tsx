  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg border border-slate-200 space-y-4">
        <div className="flex items-center gap-2 sm:gap-4 flex-wrap ">
          <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
            <Code className="w-5 h-5 sm:w-8 sm:h-8 text-blue-600" />
          </div>
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 p-4 bg-white rounded-lg border border-slate-200">
