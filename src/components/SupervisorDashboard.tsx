...
export default function SupervisorDashboard({ 
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 text-slate-800" dir={isAr ? "rtl" : "ltr"}>
      {!isOnline && (
        <div className="bg-red-50 border border-red-200 text-red-800 p-4 rounded-xl flex flex-wrap items-center gap-2 sm:gap-3">
      ...
      {activeSubTab === "emergency" && (
        <div className="space-y-6">
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 border-b pb-4 border-slate-100">
              <div className="space-y-1">
