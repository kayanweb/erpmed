            ...
            <div className="space-y-6 animate-fade-in">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
                  ...
                  <div className="text-lg sm:text-2xl font-black text-slate-800">450</div>
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
                  ...
                  <div className="text-lg sm:text-2xl font-black text-slate-800">142</div>
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
                  ...
                  <div className="text-lg sm:text-2xl font-black text-rose-600">-6</div>
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
                  ...
                  <div className="text-lg sm:text-2xl font-black text-amber-600">3.2%</div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col">
                ...
                <div className="space-y-4 flex-1">
                  <div className="p-4 bg-indigo-50 rounded-xl flex items-center justify-between border border-indigo-100">
                    ...
                    <div className="text-lg sm:text-2xl font-black text-indigo-600 font-mono">75%</div>
                  </div>
